 ...
 * It optionally shows an OK button and supports cancellability with a custom cancel listener.
 *
 * @property baseActivityInf Interface to the base activity, required to build and manage the dialog lifecycle.
